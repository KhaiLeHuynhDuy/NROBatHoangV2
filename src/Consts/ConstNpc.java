...
public class ConstNpc {
    ...
    public static final byte WHIS_154 = 56;
    public static final byte CHAMPA = 57;
    public static final byte VADOS = 58;
    public static final byte JIREN_FAKE = 59;
    ...
    public static final byte WHIS = 64;
    ...
    public static final byte TAI_XIU = 69;
    public static final byte BERRY = 71;
    public static final byte UNKOWN = 72;
    public static final byte SHOP_BIP = 78;
    public static final byte LE_TAN = 81;
    public static final byte TOPPO = 82;
    public static final byte CHI_CHI = 84;
    public static final byte CAY_THONG = 85;
    public static final byte SHOP_TAN_THU = 86;
    public static final byte YARITOBE_DO = 92;
    public static final byte PVP = 93;
    ...
    public static final byte TTMEM = 105;
    ...
    public static final int MENU_ADMIN = 2010;
    public static final int MENU_BOSS = 592;
    public static final int CALL_BOSS = 593;
    ...
    //index menu npc leTan
    public static final int MUA_CHIP = 500;
    public static final int DOI_CHIP = 501;
    ...
    //index menu Giuma
    public static final int MENU_UPDATE_BT = 500;
    public static final int MENU_UPDATE_BT_CAP2 = 501;
    public static final int MENU_UPDATE_BT_CAP3 = 502;
    public static final int MENU_UPDATE_BT_CAP4 = 503;
    ...
    public static final int CHUC_NANG_BANG_HOI = 532;
    public static final int CHUC_NANG_BANG_HOI2 = 533;
    public static final int DAT_CUOC_HAT_MIT = 534;
    public static final int BUFF_ITEM = 538;
    public static final int ADMIN = 539;
    public static final int SACH_TUYET_KY = 540;
    public static final int DONG_THANH_SACH_CU = 541;
    public static final int DONG_THANH_SACH_CU_2 = 542;
    public static final int DOI_SACH_TUYET_KY = 543;
    public static final int DOI_SACH_TUYET_KY_2 = 544;
    public static final int LOI_CHUC = 545;
    public static final int SHOW_SHENRON_NAMEK_CONFIRM = 546;
    public static final int SHENRON_NAMEK_CONFIRM = 547;
    public static final int TVMAX = 548;
    public static final int CHUC_NANG_PHA_LE_NEW = 549;
    public static final int CHUC_NANG_BONG_TAI_NE = 550;
    public static final int HO_TRO = 551;
    public static final int MENU_FIND_NOEL = 552;
    public static final int MENU_TRANG_TRI = 553;
    public static final int SUMMON_ICE_SHENRON = 554;
    public static final int TRANG_TRI_QUA_TRAU = 555;
    public static final int TRANG_TRI_NRO = 556;
    public static final int BUY_PET_VIP = 557;
    public static final int DANH_HIEU = 558;
     public static final int HOP_QUA_THAN_LINH = 559;
    public static final int SKH_TRAI_DAT = 560;
    public static final int SKH_NAMEC = 561;
    public static final int SKH_XAYDA = 562;
}
