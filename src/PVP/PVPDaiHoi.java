    ...
    public void update() {
        if(Util.canDoWithTime(lastTimePVP, 180000)){
            if(p1.nPoint.hp > p2.nPoint.hp){
                ...
                Service.gI().sendThongBao(p1, "Trận đấu hòa. Bạn nhận được " + Util.formatNumber(this.goldReward) + " vàng");
                ...
                Service.gI().sendThongBao(p2, "Trận đấu hòa. Bạn nhận được " + Util.formatNumber(this.goldReward) + " vàng");
