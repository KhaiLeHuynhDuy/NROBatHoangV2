...
public class MapMaBu {
    ...
    // Thời giam mở Map Ma Bu
    public static final byte HOUR_OPEN_MAP_MABU = 15;
    public static final byte MIN_OPEN_MAP_MABU = 30;
    public static final byte SECOND_OPEN_MAP_MABU = 0;

    // Thời giam đóng Map Ma Bu
    public static final byte HOUR_CLOSE_MAP_MABU = 17;
    public static final byte MIN_CLOSE_MAP_MABU = 30;
    ...
    private void ketThucMapMabu(Player player) {
