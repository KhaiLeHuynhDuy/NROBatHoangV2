...
import Services.func.Template.FlagBag;
import Clan.Clan;
                ...
                if (flagBag.gold > 0) {
                    if (player.inventory.gold >= flagBag.gold) {
                        ...
                        Service.gI().sendThongBao(player, "Bạn không đủ vàng, còn thiếu "
                                + Util.formatNumber(flagBag.gold - player.inventory.gold) + " vàng");
                        return;
                    }
                }
                if (flagBag.gem > 0) {
            ...
            if (clan != null) {
                ...
                try {
                    ...
                    for (ClanMember cm : clan.getMembers()) {
                        ...
                        msg.writer().writeUTF(Util.formatNumber(cm.powerPoint));
        ...
        try {
            ...
            if (player.clan == null) {
                ...
                for (ClanMessage cmg : clanMessages) {
                    ...
                    if (cmg.type == 2) {
                        msg.writer().writeUTF(cmg.playerName + " (" + Util.formatNumber(cmg.playerPower) + ")");
                    } else {
