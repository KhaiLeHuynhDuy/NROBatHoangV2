 ...
 */
package ListBoss.ConDuongRanDoc;
...
public class CADICH extends Boss {
    ...
    public void reward(Player plKill) {
        if (Util.isTrue(50, 100)) {
            ...
            it.options.add(new ItemOption(112, 80));
            it.options.add(new ItemOption(93, 90));
            it.options.add(new ItemOption(20, Util.nextInt(10000)));
