...
public class ThanKaioshinZamas extends Boss {

    public ThanKaioshinZamas() throws Exception {
        super(BossID.THAN_THAN_KAIOSHIN_ZAMAS, BossesData.THAN_KAIOSHIN_ZAMAS);
    }
